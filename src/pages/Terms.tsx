...
const sections: { title: string; body: string }[] = [
  { title: "1. Acceptance of Terms", body: `By accessing or using Aytopus ("the Platform"), you agree to be bound by these Terms of Service. If you do not agree, do not use the Platform. Aytopus is operated by Tanner Ayton ("we," "us," "our"). These terms apply to all users including buyers, coaches, service providers, and visitors.` },
  { title: "2. Eligibility", body: `You must be at least 18 years old to create an account or use Aytopus. By using the Platform you represent that you meet this requirement and that all information you provide is accurate and complete.` },
  ...
  { title: "4. User Content and Reviews", body: `By submitting a review you represent that it reflects your honest, firsthand experience. You may not submit reviews that are false, fabricated, paid for, incentivized, defamatory, harassing, or submitted on behalf of another person. You may not submit reviews for businesses or individuals with whom you have no direct experience. By submitting content to Aytopus you grant us a perpetual, non-exclusive, royalty-free, worldwide license to display, reproduce, and distribute that content on the Platform.` },
  { title: "5. Prohibited Conduct", body: `You agree not to: submit fake or manipulated reviews; impersonate any person or entity; attempt to manipulate tier rankings or trust scores; scrape, copy, or redistribute Aytopus content without permission; use automated tools or bots to interact with the Platform; harass, threaten, or abuse other users; attempt to gain unauthorized access to any account or system; use the Platform for any unlawful purpose.` },
  { title: "6. Profile Claims", body: `Coaches and service providers may claim profiles created on Aytopus. Claiming a profile does not entitle you to remove legitimate reviews. Aytopus reserves the right to verify identity before approving claims and to reject claims that cannot be adequately verified. Approved claims may be revoked if fraudulent activity is discovered.` },
  { title: "7. Content Removal", body: `Aytopus reserves the right to remove any review or content that violates these terms, is determined to be fraudulent, or is otherwise harmful to the integrity of the Platform. We are not obligated to remove content simply because a subject disagrees with it. Removal decisions are at our sole discretion.` },
  { title: "8. Disclaimer of Warranties", body: `Aytopus provides review information as a public service. We do not verify every review and cannot guarantee the accuracy, completeness, or reliability of any user-submitted content. The Platform is provided "as is" without warranties of any kind, express or implied. We do not warrant that the Platform will be uninterrupted, error-free, or free of harmful components.` },
  { title: "9. Limitation of Liability", body: `To the fullest extent permitted by law, Aytopus and its operators shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising from your use of the Platform or reliance on any content displayed thereon. Our total liability for any claim shall not exceed one hundred dollars ($100).` },
  { title: "10. Indemnification", body: `You agree to indemnify and hold harmless Aytopus and its operators from any claims, damages, losses, or expenses including reasonable legal fees arising from your use of the Platform or violation of these terms.` },
  ...
  { title: "13. Contact", body: `For questions about these terms contact us through the Aytopus app using the Send us a message feature or email us at support@aytopus.com.` },
];

...
const sections: { title: string; body: string }[] = [
  { title: "1. Introduction", body: `Aytopus ("we," "us," "our") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, store, and share your personal information when you use our platform at aytopus.com. By using Aytopus you agree to the collection and use of information as described in this policy.` },

...
const sections: { title: string; body: string }[] = [
  { title: "1. Introduction", body: `HireVy ("we," "us," "our") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, store, and share your personal information when you use our platform at hirevy.lovable.app. By using HireVy you agree to the collection and use of information as described in this policy.` },
  ...
  { title: "8. Children's Privacy", body: `HireVy is not directed to individuals under the age of 18. We do not knowingly collect personal information from minors. If we become aware that a minor has created an account we will terminate it and delete associated data promptly.` },
  { title: "9. Cookies", body: `HireVy uses essential cookies solely for authentication and session management. We do not use advertising cookies, tracking pixels, or sell cookie data to third parties.` },
  ...
  { title: "12. Contact", body: `For privacy-related questions or to exercise your rights contact us through the HireVy app using the Send us a message feature or email us at support@hirevy.com.` },
];
